...
function Start(imageFolder,defaultContent) 
{
	if (!defaultContent)
		defaultContent = '';
...
function writeRTE(imageFolder) 
{
	...
	document.writeln('		<td><img class="btnImage" src="' + imageFolder + '/images/post_button_image.gif" width="25" height="24" alt="Add Image" title="Add Image" onClick="AddImage()"></td>');
	document.writeln('	</tr>');
	document.writeln('</table>');
	document.writeln('<br>');
