...
function selectUser(tbody,tbRow,fObj,userID)
{
	...
	if (tbody.id == 'primaryUserList')
	{
		...
		userObj = fObj.elements['selectedUserID']
...
function validate(fObj)
{
	...
	if ((fObj.elements['selectedUserID'].value == ''))
	{
		aErrors[aErrors.length] = 'Select a user to apply a swim pass to.';
	}
