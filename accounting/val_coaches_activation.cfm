<!---
<fusedoc
	fuse = "val_coaches_activation.cfm"
	version = "1.0"
	language="ColdFusion">
	<responsibilities>
	...
	<properties>
		<history author="Scott Brady" date="14 November 2004" type="Create" />
	</properties>
	<io>
		<in>
			<string name="self" />
...
<cfparam name="attributes.active" default="1" type="boolean" />
...
<cfscript>
	...
	{
		variables.reason = "Coach Activated";
	}
	else
	{
		variables.reason = "Coach Deactivated";
	}
