...
<form id="announcementForm" name="announcementForm" action="#variables.baseHREF##Request.self#/fuseaction/#XFA.next#.cfm" method="post" onsubmit="return validate(this);" enctype="multipart/form-data">
...
<table width="500" border="0" cellpadding="0" cellspacing="0" align="center">
	...
	<cfif Secure("Approve Messages") AND Request.squid.announcement.sending_user EQ Request.squid.user_id>
		<tr>
		...
		<cfif Secure("Approve Messages")>
			...
			<cfloop query="qStatuses">
				<!--- The authr of a post can no longer approve them --->
				<cfif (qStatuses.status IS "Approved" AND Request.squid.announcement.sending_user NEQ Request.squid.user_id) OR qStatuses.status IS NOT "Approved">
		...
		<tr valign="top">
			...
			<cfif LEN(TRIM(Request.squid.announcement.attachment))>
				...
				<br />
				<a href="#Request.announcement_folder#/#Request.squid.announcement.attachment#" target="_blank">View attachment in new window</a> | <a href="#Request.self#/fuseaction/#XFA.delete_attachment#.cfm">Delete attachment</a>
			<cfelse>
