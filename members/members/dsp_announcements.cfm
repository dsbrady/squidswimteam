...
<table width="600" border="0" cellpadding="0" cellspacing="0" align="center">
	...
	<tbody>
		...
		<tr valign="top">
			<td align="center">
				<a href="#Request.self#/fuseaction/#XFA.edit#.cfm">Post Announcement</a>
				| <a href="#Request.self#/fuseaction/#XFA.pending#/status/Saved%20for%20Later.cfm">Your Saved Announcements</a>
			<cfif Secure("Approve Messages")>
				<br />
				| <a href="#Request.self#/fuseaction/#XFA.pending#/status/pending.cfm">Approve Pending Announcements</a>
				...
				<table cellspacing="0" cellpadding="3" align="center" class="tableClass">
					...
					<cfloop query="qryAnnouncements">
						...
						<tr class="tableRow#variables.rowClass#">
							...
							<td>
								<a href="#Request.self#/fuseaction/#XFA.detail#/announcement_id/#qryAnnouncements.announcement_id#.cfm">#truncString(qryAnnouncements.subject,35)#</a>
							</td>
							<td>
								<a href="#Request.self#/fuseaction/#XFA.detail#/announcement_id/#qryAnnouncements.announcement_id#.cfm">#truncString(qryAnnouncements.announcement_plain,35)#</a>
							</td>
						</tr>
					</cfloop>
					</tbody>
